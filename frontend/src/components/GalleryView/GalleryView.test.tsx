...
describe('GalleryView', () => {
  ...
  it('renders fullscreen comic image', () => {
  ...
  it('renders museum label with slang info', () => {
    render(<GalleryView items={mockItems} />);
  ...
  it('dot indicators count matches items', () => {
    render(<GalleryView items={mockItems} />);
